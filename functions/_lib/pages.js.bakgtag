...
const PATH = { faq: 'faq', about: 'about', feedback: 'feedback' };
const url = (lang, page) => `${CONFIG.SITE}/${lang}/${PATH[page]}`;

// Footer link labels per language (FAQ / About / Feedback / Legal / Disclosure)
const NAV = {
  en:['FAQ','About','Feedback','Legal','Disclosure'],
  fr:['FAQ','À propos','Retour','Mentions légales','Divulgation'],
  es:['Preguntas','Acerca de','Comentarios','Aviso legal','Divulgación'],
  de:['FAQ','Über uns','Feedback','Impressum','Offenlegung'],
  it:['FAQ','Chi siamo','Feedback','Note legali','Informativa'],
  pt:['Perguntas','Sobre','Comentários','Aviso legal','Divulgação'],
  nl:['FAQ','Over ons','Feedback','Juridisch','Openbaarmaking'],
  pl:['FAQ','O nas','Opinie','Informacje prawne','Ujawnienie'],
  ru:['Вопросы','О нас','Отзыв','Правовая информация','Раскрытие'],
  tr:['SSS','Hakkında','Geri bildirim','Yasal','Açıklama'],
  ar:['الأسئلة','من نحن','ملاحظات','قانوني','الإفصاح'],
  fa:['سؤالات','درباره','بازخورد','حقوقی','افشا'],
  hi:['सामान्य प्रश्न','परिचय','प्रतिक्रिया','कानूनी','प्रकटीकरण'],
  bn:['প্রশ্নাবলী','সম্পর্কে','মতামত','আইনি','প্রকাশ'],
  th:['คำถาม','เกี่ยวกับ','ความคิดเห็น','กฎหมาย','การเปิดเผย'],
  vi:['Hỏi đáp','Giới thiệu','Phản hồi','Pháp lý','Tiết lộ'],
  id:['FAQ','Tentang','Masukan','Hukum','Pengungkapan'],
  ja:['よくある質問','概要','フィードバック','法的事項','開示'],
  ko:['자주 묻는 질문','소개','피드백','법적 고지','공개'],
  zh:['常见问题','关于','反馈','法律','披露'],
};
...
<a href="${L}/faq">${esc(n[0])}</a> · <a href="${L}/about">${esc(n[1])}</a> · <a href="${L}/feedback">${esc(n[2])}</a> · <a href="${CONFIG.SITE}/legal/">${esc(n[3])}</a> · <a href="${CONFIG.SITE}/disclosure/">${esc(n[4])}</a>
